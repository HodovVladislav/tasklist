...
public class UserDto {
    ...
    @Schema(description = "User encrypted password", example = "$2a$10$9CFUzmo7skp.twm5R7bcROSB5YiT6XjmA1teWbBqGRtsUYlvfmBxa")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    @NotNull(message = "Password should not be empty", groups = {OnCreate.class, OnUpdate.class})
    private String password;


    @Schema(description = "User encrypted password confirmation", example = "$2a$10$9CFUzmo7skp.twm5R7bcROSB5YiT6XjmA1teWbBqGRtsUYlvfmBxa")
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)

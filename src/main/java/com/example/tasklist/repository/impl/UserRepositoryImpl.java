...
public class UserRepositoryImpl implements UserRepository {
    ...
    public Optional<User> findByUsername(String username) {
        try {
            ...
            throw new ResourceMappingException("Cannot find user by username");
        }
    }
    ...
    public void update(User user) {
        try {
            ...
            throw new ResourceMappingException("Cannot update user");
        }
    }
    ...
    public void create(User user) {
        try {
            ...
            throw new ResourceMappingException("Cannot create user");
        }
    }
    ...
    public void insertUserRole(long userId, Role role) {
        try {
            ...
            throw new ResourceMappingException("Cannot insert user role");
        }
    }
    ...
    public boolean isTaskOwner(long userId, long taskId) {
        try {
            ...
            throw new ResourceMappingException("Cannot check is task owner");
        }
    }
    ...
    public void delete(long id) {
        try {
            ...
            throw new ResourceMappingException("Cannot delete user");
        }
